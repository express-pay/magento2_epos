...
namespace Expresspay\Epos\Model;
...
/**
 * Class Epos
 * @package Expresspay\Epos\Model
 */
class Epos extends \Magento\Payment\Model\Method\AbstractMethod
{
    const CODE = 'epos';
    /**
     * @var bool
    ...
    )
    {
        ...
        parent::__construct($context,
            ...
            $resourceCollection,
            $data);
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/expresspay_epos.log');
