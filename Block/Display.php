...
namespace Expresspay\Epos\Block;
...
class Display extends \Magento\Framework\View\Element\Template
{
	...
	/**
	 * @var \Expresspay\Epos\Model\Epos
	 */
	protected $Config;
	...
	public function __construct(
		...
		\Expresspay\Epos\Model\Epos $paymentConfig,
		array $data = []
	) {
	...
	{
		$epos_code  = $this->Config->getConfigData("EPOS_CODE") ."-";
		$epos_code .= "1-";
		$epos_code .= $this->_coreRegistry->registry('foo');
